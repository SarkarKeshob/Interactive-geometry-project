...
triangleCalculate.addEventListener('click',function(){
    ...
    if(check!==0){
        ...
        areaShower('The Area of Your Triangle Is =  '+(0.5*check)+' square cm ');
...
rectangleCalculate.addEventListener('click',function(){
    ...
    if(check!==0){
        areaShower('The Area of Your Rectangle Is =  '+check+' square cm ');
...
parallelogramCalculate.addEventListener('click',function(){
    ...
    if(check!==0){
        areaShower('The Area of Your Parallelogram Is =  '+check+' square cm ');
...
rhombusCalculate.addEventListener('click',function(){
    ...
    if(check!==0){
        areaShower('The Area of Your Rhombus Is =  '+(0.5*check)+' square cm ');
...
pentagonCalculate.addEventListener('click',function(){
    ...
    if(check!==0){
        areaShower('The Area of Your Pentagon Is =  '+(0.5*check)+' square cm ');
...
ellipseCalculate.addEventListener('click',function(){
    ...
    if(check!==0){
        areaShower('The Area of Your Ellipse Is =  '+(3.1416*check)+' square cm ');
